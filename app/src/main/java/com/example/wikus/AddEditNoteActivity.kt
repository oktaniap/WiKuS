...
class AddEditNoteActivity : AppCompatActivity() {
    companion object {
        const val EXTRA_ID = "com.example.wikus.EXTRA_ID"
        const val EXTRA_JUDUL = "com.example.wikus.EXTRA_JUDUL"
        const val EXTRA_DESKRIPSI = "com.example.wikus.EXTRA_DESKRIPSI"
        const val EXTRA_PRIORITAS = "com.example.wikus.EXTRA_PRIORITAS"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Klik dari intent, jika ada isinya maka edit jika tidak maka tambah
